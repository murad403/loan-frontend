        ...
        <div>
            ...
            <div className='px-4 py-7'>
                <div className="flex items-center flex-col md:gap-5 gap-3">
                    ...
                    <h4 className="text-md font-semibold">FCFA 100,000</h4>
                    <p className="text-sm text-gray-700">Based on your credit score of 95/1000</p>
                </div>
                <div className="bg-gray-100 rounded-sm p-3 space-y-3 mt-7">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <h4 className="text-[14px] font-semibold">FCFA 100,000</h4>
                    </div>
                    <div className="flex justify-between items-center">
                        <p className="text-sm text-gray-700">Goode(60-79):</p>
                        <h4 className="text-[14px] font-semibold">FCFA 100,000</h4>
                    </div>
                    <div className="flex justify-between items-center">
